...
var Ue = (n3, e, t) => e in n3 ? Ne(n3, e, { enumerable: true, configurable: true, writable: true, value: t }) : n3[e] = t;
var oe = (n3, e, t) => (Ue(n3, typeof e != "symbol" ? e + "" : e, t), t);
var B = Symbol("map");
var Z = Symbol("api");
var pe = Symbol("marker");
var fe = Symbol("markerCluster");
var re = Symbol("CustomMarker");
var Te = Symbol("mapTilesLoaded");
var V = [
  "click",
  "dblclick",
  "drag",
...
var q = class _q {
  ...
  constructor({ apiKey: e, authReferrerPolicy: t, channel: s, client: r, id: o = ye, language: a, libraries: l = [], mapIds: i, nonce: d, region: u, retries: c = 3, url: h = "https://maps.googleapis.com/maps/api/js", version: p }) {
    if (this.callbacks = [], this.done = false, this.loading = false, this.errors = [], this.apiKey = e, this.authReferrerPolicy = t, this.channel = s, this.client = r, this.id = o || ye, this.language = a, this.libraries = l, this.mapIds = i, this.nonce = d, this.region = u, this.retries = c, this.url = h, this.version = p, _q.instance) {
      if (!ze(this.options, _q.instance.options))
        throw new Error(`Loader must not be called again with different options. ${JSON.stringify(this.options)} !== ${JSON.stringify(_q.instance.options)}`);
      return _q.instance;
    }
    _q.instance = this;
  }
  ...
  setup(n3, { emit: e }) {
    ...
    const l = () => {
      ...
      const p = (m) => {
        ...
        cameraControlOptions: p(n3.cameraControlPosition),
      ...
      try {
        const { apiKey: c, region: h, version: p, language: f, libraries: m, nonce: g } = n3;
    ...
    return Ie(() => {
      n3.apiPromise && n3.apiPromise instanceof Promise ? n3.apiPromise.then(u) : (d(), _e.load().then(u));
    }), j(() => {
      var c;
...
function Ke(n3, e, t, s, r, o) {
  return K(), Y("div", null, [
    se("div", We, null, 512),
    J(n3.$slots, "default", De(Fe({ ready: n3.ready, map: n3.map, api: n3.api, mapTilesLoaded: n3.mapTilesLoaded })), void 0, true)
  ]);
}
var At = X(He, [["render", Ke], ["__scopeId", "data-v-e7ebb206"]]);
function Ye(n3) {
...
var A = Ye(Je);
var ke = ["click", "drag", "dragend", "dragstart", "gmp-click"];
var Xe = P({
  name: "AdvancedMarker",
  props: {
    options: {
  ...
  setup(n3, { emit: e, expose: t, slots: s }) {
    ...
    }), a = $(n3, "options"), l = $(n3, "pinOptions"), i = v(), d = C(B, v()), u = C(Z, v()), c = C(fe, v()), h = F(
...
function et(n3, e, t, s, r, o) {
  return n3.hasSlotContent ? (K(), Y("div", Qe, [
    se("div", de({ ref: "markerRef" }, n3.$attrs), [
      J(n3.$slots, "default")
    ], 16)
  ])) : he("", true);
}
var It = X(Xe, [["render", et]]);
var tt = (n3) => n3 === "Marker";
var st = (n3) => n3 === re;
var z = (n3, e, t, s) => {
  ...
  return S(
    ...
    (d, [u, c]) => {
      ...
      !o.value || !a.value || !h || (r.value ? (r.value.setOptions(t.value), i.value && ((p = l.value) == null || p.removeMarker(r.value), (f = l.value) == null || f.addMarker(r.value))) : (tt(n3) ? r.value = x(
...
var Tt = P({
  ...
  emits: Ce,
  setup(n3, { emit: e, expose: t, slots: s }) {
    const r = $(n3, "options"), o = z("Marker", Ce, r, e);
...
var be = V.concat(["bounds_changed"]);
var qt = P({
  name: "Rectangle",
  props: {
    options: {
...
var Me = V.concat(["center_changed", "radius_changed"]);
var jt = P({
  name: "Circle",
  props: {
    options: {
...
function ot(n3, e, t, s, r, o) {
  return K(), Y("div", nt, [
    J(n3.$slots, "default", {}, void 0, true)
  ], 512);
}
var Bt = X(rt, [["render", ot], ["__scopeId", "data-v-d099a3a6"]]);
var Oe = ["closeclick", "content_changed", "domready", "position_changed", "visible", "zindex_changed"];
var it = P({
  inheritAttrs: false,
  props: {
    options: {
  ...
  setup(n3, { slots: e, emit: t, expose: s }) {
    ...
    const c = F(() => {
      ...
      r.value && (r.value.open({ map: a.value, anchor: i.value, ...m }), h(true));
    }, f = () => {
...
function lt(n3, e, t, s, r, o) {
  return n3.hasSlotContent ? (K(), Y("div", at, [
    se("div", de({ ref: "infoWindowRef" }, n3.$attrs), [
      J(n3.$slots, "default", {}, void 0, true)
    ], 16)
  ])) : he("", true);
}
var Zt = X(it, [["render", lt], ["__scopeId", "data-v-cbe1707b"]]);
var Ee = [
  Int8Array,
  Uint8Array,
  Uint8ClampedArray,
...
function ce(n3, e, t, s, r, o) {
  if (r - s <= t)
    return;
  const a = s + r >> 1;
  $e(n3, e, a, s, r, o), ce(n3, e, t, s, a - 1, 1 - o), ce(n3, e, t, a + 1, r, 1 - o);
}
function $e(n3, e, t, s, r, o) {
  for (; r > s; ) {
    if (r - s > 600) {
    ...
    const a = e[2 * t + o];
    let l = s, i = r;
    for (H(n3, e, s, t), e[2 * r + o] > a && H(n3, e, s, r); l < i; ) {
      for (H(n3, e, l, i), l++, i--; e[2 * l + o] < a; )
        l++;
      for (; e[2 * i + o] > a; )
        i--;
    }
    e[2 * s + o] === a ? H(n3, e, s, i) : (i++, H(n3, e, i, r)), i <= t && (s = i + 1), t <= i && (r = i - 1);
  }
}
function H(n3, e, t, s) {
  ae(n3, t, s), ae(e, 2 * t, 2 * s), ae(e, 2 * t + 1, 2 * s + 1);
}
function ae(n3, e, t) {
  const s = n3[e];
  n3[e] = n3[t], n3[t] = s;
}
function Pe(n3, e, t, s) {
  const r = n3 - t, o = e - s;
  return r * r + o * o;
}
var ct = {
...
var Se = Math.fround || /* @__PURE__ */ ((n3) => (e) => (n3[0] = +e, n3[0]))(new Float32Array(1));
var R = 2;
var T = 3;
var le = 4;
var I = 5;
...
function Le(n3, e, t) {
  return {
    type: "Feature",
    id: n3[e + T],
    properties: je(n3, e, t),
    geometry: {
      type: "Point",
      coordinates: [ut(n3[e]), dt(n3[e + 1])]
    }
  };
}
function je(n3, e, t) {
  const s = n3[e + I], r = s >= 1e4 ? `${Math.round(s / 1e3)}k` : s >= 1e3 ? `${Math.round(s / 100) / 10}k` : s, o = n3[e + Re], a = o === -1 ? {} : Object.assign({}, t[o]);
...
var ht = (n3, e, t, s) => {
  const r = Be(n3.getBounds(), e, s);
  return t.filter((o) => r.contains(k.getPosition(o)));
};
var Be = (n3, e, t) => {
  const { northEast: s, southWest: r } = pt(n3, e), o = ft({ northEast: s, southWest: r }, t);
  return mt(o, e);
};
var xe = (n3, e, t) => {
  const s = Be(n3, e, t), r = s.getNorthEast(), o = s.getSouthWest();
...
var ft = ({ northEast: n3, southWest: e }, t) => (n3.x += t, n3.y -= t, e.x -= t, e.y += t, { northEast: n3, southWest: e });
var mt = ({ northEast: n3, southWest: e }, t) => {
...
var ve = class _ve {
  constructor() {
    Ct(_ve, google.maps.OverlayView);
  }
};
var D;
(function(n3) {
      ...
      () => {
        o.value && (r.value = x(
          new Mt({
            ...
            algorithm: new _t(n3.options.algorithmOptions ?? {}),
            ...n3.options
          })
        ), Ae.forEach((l) => {
          var i;
...
function Pt(n3, e, t, s, r, o) {
  return n3.hasSlotContent ? (K(), Y("div", Et, [
    se("div", de({
      ref: "customMarkerRef",
...
var Ut = X(Ot, [["render", Pt], ["__scopeId", "data-v-2d2d343a"]]);
var Dt = P({
  name: "HeatmapLayer",
  props: {
    options: {
